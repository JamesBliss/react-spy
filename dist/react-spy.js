(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["reactSpy"] = factory(require("React"));
	else
		root["reactSpy"] = factory(root["React"]);
...
class Spy extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  constructor(props) {
    super(props);
  ...
  renderChildren() {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.Children.map(children, child => {
  ...
  render() {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(elementType, {
      className,
      ref: wrapper => {
...
Spy.propTypes = {
  ...
  elementType: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string
};
